function Footer(){
  ...
  <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul className="nav col-md-4 justify-content-end">
      ...
      <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Pizza</a></li>
      <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Services</a></li>
      <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Contact Us</a></li>
    </ul>
    <p className="text-center text-body-secondary">@ 2024 Pizza Store</p>
  </footer>
</div>
        </>
      )
